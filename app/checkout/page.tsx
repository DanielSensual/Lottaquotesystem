...
function CheckoutContent() {
    ...
    const desc = searchParams.get('desc') || 'ATHEIA — Brand Photoshoot';
    ...
    return (
        <>
            <style jsx global>{`
                :root {
                    --bg: #050505; --card: #111111; --card-border: rgba(255,255,255,0.09);
                    --white: #f5f5f7; --muted: #a1a1a6;
                    --accent: #ffffff; --green: #22c55e;
                }
                * { margin: 0; padding: 0; box-sizing: border-box; }
                body { background: var(--bg); color: var(--white); font-family: 'Inter', 'SF Pro Display', sans-serif; }
                .checkout-shell {
                ...
                .checkout-amount {
                    font-size: 36px; font-weight: 800; color: var(--white); letter-spacing: -0.04em;
                }
            ...
            <div className="checkout-shell">
                <div className="checkout-card">
                    <div className="checkout-brand">ATHEIA</div>
...
export default function CheckoutPage() {
    return (
        <Suspense fallback={
            <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#050505', color: '#a1a1a6', fontFamily: 'Inter, sans-serif' }}>
                Loading checkout...
            </div>
        }>
            <CheckoutContent />
